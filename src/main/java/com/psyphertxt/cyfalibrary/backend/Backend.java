package com.psyphertxt.cyfalibrary.backend;
...
public class Backend {
    ...
    public interface Account {
         ...
         * @param onUser
         */
        void getCurrentUser(final AccountListener.onUser onUser);
    ...
    public interface Notifications {
         ...
         *
         * @param callbackForResults returns success with a pushId or error
         */
         ...
         * a group
         */
        //void send(UserContact userContact, String title, String message);
